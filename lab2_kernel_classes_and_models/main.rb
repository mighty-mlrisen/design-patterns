...
student1 = Student.new(name: 'Artem', surname: 'Mazurenko', patronymic: 'Alekseevich',id: 1, phone: '890967534871',telegram: 'skimaskway',email: 'mazurenko@yandex.ru',git: 'https://github.com/mighty-mlrisen')
