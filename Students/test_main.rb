...
json = Students_list.new('./students.json',Students_list_strategy_json.new())

json.read

puts json.get_student_by_id(2)

data_list2 = json.get_k_n_student_short_list(1, json.get_student_short_count)
...
puts ("РРРРРРРР: #{table2.row_count}")
print_table table2
